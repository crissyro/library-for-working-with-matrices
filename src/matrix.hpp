...
public:
    ...
    /**
     * @brief Проверяет, является ли матрица диагонализируемой.
     * 
     * Диагонализируемая матрица — это матрица, которую можно привести к диагональной форме
     * при помощи подобия (умножения на обратимую матрицу).
     * 
     * @tparam T Тип элементов матрицы.
     * @return true, если матрица диагонализируемая, иначе false.
     */
